...
public class SearchOrderResultFinished extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if ((bundle = getIntent().getExtras()) != null) {
            ...
            if(orderList.static_order_id.isEmpty()){
                order_Id = null;
            }
            else{
    ...
    public void showData() throws MalformedURLException {
        try{
            ...
            String Order_name = null, Order_phone = null, Order_Address = null, Order_Type = null, Order_GasQuan = null;
            ...
            Log.i("Finished Order Info Exception", e.toString());
        }
    }
